# Generated by Django 2.1.5 on 2019-03-19 12:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='记录论坛文章的标题', max_length=255, verbose_name='标题')),
                ('text', models.TextField(help_text='记录论坛文章内容', verbose_name='内容')),
